...
export const translations = {
  en: {
    ...
    about: {
      ...
      values: [
        { icon: "🌿", title: "Sustainability", desc: "Eco-friendly practices and ethical sourcing in every collection." },
        { icon: "✨", title: "Quality", desc: "Premium materials with meticulous attention to detail." },
        { icon: "🤝", title: "Inclusivity", desc: "Fashion for everybody — all shapes, sizes, and styles." },
        { icon: "🚀", title: "Innovation", desc: "Constantly evolving with the freshest trends and silhouettes." },
      ],
    ...
    contact: {
      ...
      info: [
        ...
        { icon: "✉️", label: "Email", value: "hello@haven.style" },
  ...
  ar: {
    ...
    home: {
      ...
      promos: [
        { icon: "🚚", text: "شحن مجاني على $50+" },
        { icon: "↩️", text: "إرجاع سهل خلال 30 يوماً" },
    ...
    about: {
      ...
      valuesTitle: "قيمنا",
      values: [
        { icon: "🌿", title: "الاستدامة", desc: "ممارسات صديقة للبيئة في كل مجموعة." },
        { icon: "✨", title: "الجودة", desc: "أجود المواد مع الاهتمام بكل التفاصيل." },
        { icon: "🤝", title: "الشمولية", desc: "الموضة للجميع — كل الأشكال والأساليب." },
        { icon: "🚀", title: "الابتكار", desc: "نتطور دائماً لنقدّم أحدث الاتجاهات." },
      ],
    ...
    contact: {
      ...
      info: [
        ...
        { icon: "✉️", label: "البريد", value: "hello@haven.style" },
