-- Clothing Shop Database Migration
-- Apply this in Supabase SQL Editor
-- Location: https://app.supabase.com → SQL Editor → + New Query

CREATE TYPE "public"."order_status" AS ENUM('pending', 'confirmed', 'processing', 'shipped', 'delivered', 'cancelled', 'refunded');
CREATE TYPE "public"."payment_method" AS ENUM('stripe', 'paypal', 'cash_on_delivery');
